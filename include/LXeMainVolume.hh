...
public:
  ...
  G4LogicalVolume *GetLogScint() { return detector_vol->getScintLogical(); }
  G4LogicalVolume* GetLogMPPC() { return detector_vol->getMPPCLogical(); }
...
private:
  ...
  std::unique_ptr<VolumeDetector> detector_vol;
  ...
  G4VPhysicalVolume *fDetector_vol;

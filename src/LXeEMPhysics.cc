...
void LXeEMPhysics::ConstructProcess()
{
  ...
  pManager->AddProcess(fElectronMultipleScattering, -1, 1, 1);// マルチ散乱
  pManager->AddProcess(fElectronIonisation,         -1, 2, 2);// 電離損失
  pManager->AddProcess(fElectronBremsStrahlung,     -1, 3, 3);// 制動放射

  //Positron Physics
  pManager = G4Positron::Positron()->GetProcessManager();
  pManager->AddProcess(fPositronMultipleScattering, -1, 1, 1);// マルチ散乱
  pManager->AddProcess(fPositronIonisation,         -1, 2, 2);// 電離損失
  pManager->AddProcess(fPositronBremsStrahlung,     -1, 3, 3);// 制動放射
  pManager->AddProcess(fAnnihilation,                0,-1, 4);// 対消滅
